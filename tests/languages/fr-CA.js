...
exports['language:fr'] = {
    ...
    currency: function (test) {
        ...
        var tests = [
            [1000.234,'0,0.00 $','1\xa0000,23\xa0$'],
            [-1000.234,'(0,0 $)','(1\xa0000\xa0$)'],
            [-1000.234,'0.00 $','-1000,23\xa0$'],
            [1230974,'(0.00 a$)','1,23\xa0M$']
        ];
    ...
    percentages: function (test) {
        ...
        var tests = [
            [1,'0 %','100\xa0%'],
            [0.974878234,'0.000 %','97,488\xa0%'],
            [-0.43,'0 %','-43\xa0%'],
            [0.43,'(0.000 %)','43,000\xa0%']
        ];
